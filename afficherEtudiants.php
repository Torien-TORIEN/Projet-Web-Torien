...
<main role="main">
        <div class="jumbotron" style="background-image:url('img/im2.jpg')">
            <div class="container" style="text-align:center;border:10px solid blue;border-radius:10px;color:#E0FFFF">
              <h1 class="display-4" style="border-style:none  none solid none">Liste des étudiants</h1>
