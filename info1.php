<?php
   ...
   if($_SESSION["autoriser"]!="oui"){
    ...
    $_SESSION["url"]=str_replace("&","&amp;","http://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI']);
       ...
       $query="SELECT * FROM etudiant WHERE Classe in(select nom from groupe where nom LIKE 'INFO1%'AND login='$login')" ;
...
<body>
  ...
  <main role="main">
          <div class="jumbotron" style="background-image:url('img/im4.jpg')">
              <div class="container">
                  <br>
                  <br>
                  <button class="spinner-grow spinner-grow-sm" id="anim1" style="width:16%;left:50px"><a href="info2.php" role="button" style="color:black;width:100%"></a></button>
                  <h1 ><?= $bienvenue ?></h1>
                <h4 style="color:#FF4500">Tous vos  étudiants de la prémière année informatique : INFO1</h4>
  ...
  <div class="container">
    <div class="row">
          ...
          <button class="btn btn-success" id="info2" style="width:16%"><a href="info2.php" role="button" style="color:black;width:100%">Voir aussi INFO2 &raquo;</a></button>
          <button class="btn btn-info" id="info3" style="width:16%"><a href="info3.php" role="button" style="color:white">Voir aussi INFO3 &raquo;</a></button>
            <!-- <p><a class="btn btn-success" id="info2" href="info2.php" role="button" style="width:49%" >Voir aussi INFO2 &raquo;</a></p>
            <p><a class="btn btn-warning sec" id="info3" href="info3.php" role="button" style="width:49%">Voir aussi INFO3 &raquo;</a></p> -->
          ...
          <div class="table-responsive"> 
                <br>
                  ...
                  <?php
                      ...
                      echo "<div class='alert alert-danger' role='alert'><h5 class='text-danger text-center mt-3'> Vous n\'avez aucun étudiant de INFO1</h5></div>";
                  }
              }
  ...
  <script>
    $(document).ready(function(){
      $("#info2").mouseover(function(){
        document.getElementById("info2").style.width="50%";
        $("#info3").hide();
      });
      $("#info2").mouseout(function(){
        document.getElementById("info2").style.width="16%";
        $("#info3").show();
      });
      $("#info3").mouseover(function(){
        document.getElementById("info3").style.width="50%";
        $("#info2").hide();
      });
      $("#info3").mouseout(function(){
        document.getElementById("info3").style.width="16%";
        $("#info2").show();
      });
