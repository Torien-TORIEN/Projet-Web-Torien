<?php
    ...
    if($_SESSION["autoriser"]!="oui"){
        ...
        $dem="SELECT nom from groupe where id=$id order by nom ASC";
        ...
        if($reponse->rowCount()>0){
            ...
            echo $table;
             ...
             $erreuravant='<div class="alert alert-warning" role="alert"><h4 style="text-align:center;">Aucun étudiant de ce groupe: '.$groupe.'</h4></div>';
            echo $erreurapres='<div class="alert alert-danger alert-dismissible">
                  <button type="button" class="close" data-dismiss="alert">&times;</button>
                  <strong>OUPS ! </strong> Aucun étudiant de ce groupe: '.$groupe.'
                </div>';
        }
    }
